          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: Icon(Icons.person_outline, color: Colors.pink.shade300, size: 20),
                filled: true,
                ...
                errorText: state.name.isEmpty ? null : (state.name.length < 3 ? "Nama minimal 3 karakter" : null),
